...
"""
INSERT INTO public.pageallocation (id, route, name, image, psection, ssection, pposition, sposition, status) 
VALUES (2, 'account-settings', 'Account Settings', 'bx bx-layout', 'Settings', 'Settings', 2, 1);
"""
